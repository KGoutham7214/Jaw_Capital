      ...
      <div class="container">
        <div class="logo-container">
          <a routerLink="/" class="logo" aria-label="JAW Logo">
            <img *ngIf="themeService.isDarkMode()" src="assets/darkmode-1-bg.png" alt="JAW Capital Management" />
          </a>
          <a routerLink="/" class="logo text-only" aria-label="JAW Logo">
            <img *ngIf="!themeService.isDarkMode()" src="assets/normal-1.png" alt="JAW Capital Management" />
          </a>
        </div>
